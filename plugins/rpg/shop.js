...
async function handler(m, { sock }) {
    ...
    if (action === 'buy') {
        ...
        db.db.data.users[cleanJid].balance = (db.db.data.users[cleanJid].balance || 0) - totalCost
    ...
    if (action === 'sell') {
        ...
        db.db.data.users[cleanJid].balance = (db.db.data.users[cleanJid].balance || 0) + totalProfit
